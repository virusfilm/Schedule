...
?>
    	<tr  height="30"  bgcolor="#d8ffca">
            ...
            <td align="center"><a href="index.php?frm=frm_edit_teacher&id=<? echo $row['ID']; ?>" onMouseover="showhint('<? echo $str_cmp;?>', this, event, '150px')"><img src="images/user_edit.png" alt="" title="" border="0" /></a></td>
        </tr>
<?
	$i++;
  }
  ...
  printf("มีอาจารย์ %d ท่าน / ",$total);
			...
			for($i=1;$i<=$page;$i++)
			{
				...
				{ //ถ้าตัวแปล page ตรง กับ เลขที่วนได้
					echo "<font color='#ff0000'>[<a href='?frm=edit_teacher&start=".$limit*($i-1)."&page=$i' style='text-decoration:none;'><B>$i</B></a>]</font>"; //ลิ้งค์ แบ่งหน้า เงื่อนไขที่ 1
				}
				else
				{
					echo "[<a href='?frm=edit_teacher&start=".$limit*($i-1)."&page=$i' style='text-decoration:none;'>$i</a>]"; //ลิ้งค์ แบ่งหน้า เงื่อนไขที่ 2
				}
			}
?>    
</td>
