...
{var a=new Array();
	...
	if(document.frm_manage_schedule.dat1.value == "")
	{
		alert('กรุณาเลือกวัน เดือน ปี ที่เริ่มสอน');
		document.frm_manage_schedule.dat1.focus();
		return false;
	}
	 var p=0;
...

{
	...
	$sqlSS="select * from schedule where generation='$generation'";
	$querySS=mysql_query($sqlSS);;
	$nc=mysql_num_rows($querySS);
	list($day1A,$month1A,$year1A)=explode("/",$_POST['dat1']); 
	
	if($nc != 0) { 
	 echo '
<SCRIPT language=JavaScript>  alert("ชื่อตารางสอนของรุ่นซ้ำกัน ! ลองใหม่...");  </script>
';
	}else if (check_day($day1A,$month1A,$year1A)!="Sat"&&check_day($day1A,$month1A,$year1A)!="Sun"){
		echo '
<SCRIPT language=JavaScript>  alert("กรุณาเลือกวันที่เปิดเรียนให้ตรงวันเสาร์หรืออาทิตย์ !  ลองใหม่...");  </script>
';
}else {
	?>
	<div id="loading-overlay"></div>
<div id="loading-message" ><font color="#FF0000" >กำลังจัดตารางสอน , กรุณารอสักครู่...</font></div>
<?
$c2=0;
$c21=0;
$c22=0;
...
/*for($i=0;$i<count($t_m);$i++){
	echo $k=mt_rand($t_m[$i],$t_m[count($t_m)])."<br/>";
	}
*/
...
////////////////////////////////////////////////////////////////// end if all ////////////////////////////////////////////////////////////////////////////////////////					
				...
				$sqlSaveA="insert into schedule values ('','$s_day[$z3]','0','0','0','$generation','1','$c_place')";
