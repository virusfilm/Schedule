...
<?
 ...
 header('Content-Disposition: attachment; filename="schedule_place.doc"')
?>
<html>
<head>
...
<tr>
<td colspan="3" align="center" height="100" class="table4">สถาบันพลังจิตตานุภาพในภาคใต้<br>ตารางสอนหลักสูตรครูสมาธิ  รุ่นที่  <?=$rww['generation']; ?>   ณ <?=$rwPP['location_name']; ?></td>
</tr>
