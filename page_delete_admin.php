...
<div class="warning_box">
  <b>ลบข้อมูลผู้ดูแลระบบระดับสาขา</b>
</div> 
<table width="620"  cellpadding="2" cellspacing="2" border="0" bordercolor="#CCCCCC" >
    	<tr height="40" bgcolor="#87d9fa">
			...
			<th scope="col" class="rounded" align="center">ลบ</th>
        </tr>
<?
...
?>
    	<tr  height="30"  bgcolor="#d8ffca">
            ...
            <td align="center"><a href="index.php?frm=delete_admin&id=<? echo $row['ID']; ?>" ><img src="images/trash.png" alt="" title="" border="0" /></a></td>
        </tr>
<?
	$i++;
  }
  ...
  printf("มีอาจารย์ %d ท่าน / ",$total);
			...
			for($i=1;$i<=$page;$i++)
			{
				...
				{ //ถ้าตัวแปล page ตรง กับ เลขที่วนได้
					echo "<font color='#ff0000'>[<a href='?frm=delete_admin&start=".$limit*($i-1)."&page=$i' style='text-decoration:none;'><B>$i</B></a>]</font>"; //ลิ้งค์ แบ่งหน้า เงื่อนไขที่ 1
				}
				else
				{
					echo "[<a href='?frm=delete_admin&start=".$limit*($i-1)."&page=$i' style='text-decoration:none;'>$i</a>]"; //ลิ้งค์ แบ่งหน้า เงื่อนไขที่ 2
				}
			}
?>    
</td>
