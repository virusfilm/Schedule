...
$sql= "select 	id_place,generation,location_name,status,id_teacher from schedule,place where place.id = schedule.id_place and schedule.status=0 and schedule.id_teacher='$s_teacher_id' group by generation ";
...
//show_schedule.php?>
<a href="show_schedule5.php?mode=<?=$generation[$k]; ?> " target="_blank">ตารางสอนหลักสูตรครูสมาธิ  รุ่นที่  <?=$generation[$k]; ?> จำนวน  
