...
<body>
 <div class="valid_box">
   <b>เพิ่มข้อมูลผู้ดูแลระบบระดับสาขา !</b>
 </div>
<?
       ...
       <fieldset>
         <form action="" method="post" class="niceform" enctype="multipart/form-data" onSubmit="return check_input();" name="page_add_admin">
                    ...
                    <dl>
                        ...
                        <dd><input type="text" name="Username" id="Username" size="40" onChange="processdata();"  class="text"/><span id="display"></span></dd>
                    </dl>
                    <dl>
                        <dt><label for="T_password">รหัสผ่าน :</label></dt>
                        <dd><input type="password" name="Password" id="Password" size="40"  class="text"/></dd>
                    </dl>
					<dl>
                  ...
                  <label for="T_name">ชื่อผู้ดูแลระบบ :</label></dt>
                        <dd><input type="text" name="Name" id="Name" size="40"  class="text"/></dd>
                    </dl>
					<dl>
                        <dt>
